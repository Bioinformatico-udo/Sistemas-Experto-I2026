...
const formatCharacterName = (name: string | undefined, capitalize: boolean = false): string => {
  if (!name) return "";
  const customMap: Record<string, string> = {
    color_verde_no_calc: "color verde y talo no calcificado",
    color_pardo: "color pardo",
    estructura_cenocitica: "estructura cenocítica",
    estolones_rizoides_filoides: "estolones, rizoides y filoides",
    talo_calcificado: "talo calcificado",
    talo_tubular: "talo tubular",
    filoides_pectinados: "filoides pectinados",
    filoides_planos_enteros: "filoides planos y enteros",
    ramulos_vesiculosos: "rámulos vesiculosos",
    vesiculas_diminutas: "vesículas diminutas",
    ramulos_turbinados: "rámulos turbinados",
    pinnulas_apice_obtuso_denticuladas: "pínnulas con ápice obtuso denticuladas",
    talo_laminar_o_tubular_hueco: "talo laminar o tubular hueco",
    lamina_rigida_dientes_margen: "lámina rígida con dientes en el margen",
    filamentos_simples_no_ramificados: "filamentos simples no ramificados",
    ramas_verticiladas_sombrilla: "ramas verticiladas en forma de sombrilla",
    malla_reticulada: "malla reticulada",
    presencia_vesiculas_filoides_estipe: "presencia de vesículas, filoides y estipe",
    habito_pelagico: "hábito pelágico",
    aerocistos_apiculados: "aerocistos apiculados",
    filoides_espinosos_limbo: "filoides espinosos en el limbo",
    filoides_densos_cortos_aserrados: "filoides densos, cortos y aserrados",
    vesiculas_pequenas_racimos_axilares: "vesículas pequeñas en racimos axilares",
    filoides_lineares_delgados: "filoides lineares delgados",
    talo_globoso_hueco: "talo globoso hueco",
    talo_abanico_bandas_concentricas: "talo en forma de abanico con bandas concéntricas",
    talo_cilindrico_cartilaginoso: "talo cilíndrico cartilaginoso",
    talo_plano_laminar_cintiforme: "talo plano laminar cintiforme",
    nervadura_media_costilla: "nervadura media o costilla",
    ramificacion_palmeada_irregular: "ramificación palmeada irregular",
    giros_helicoidales_ramas: "giros helicoidales en las ramas",
    margen_con_dientes: "margen con dientes",
    dientes_tipo_pestaña: "dientes tipo pestaña",
    iridiscencia_azul: "iridiscencia azul",
    celula_apical_negra: "célula apical negra",
    propagulos_delgados_cilindricos: "propágulos delgados cilíndricos",
    ramificacion_angulo_recto: "ramificación en ángulo recto",
    talo_articulado_rigido: "talo articulado rígido",
    talo_blando_laurencia: "talo blando tipo Laurencia",
    talo_filamentoso_fino: "talo filamentoso fino",
    apices_pincetas_cangrejo: "ápices en forma de pincetas de cangrejo",
    corticacion_nodal_eje: "corticación nodal en el eje",
    ramillas_espinosas_apical: "ramillas espinosas en el ápice",
    presencia_espinas_agudas: "presencia de espinas agudas",
    ejes_angulados_tristicos: "ejes angulados trísticos",
    espinas_en_ejes_principales: "espinas en ejes principales",
    ramulos_hoyuelo_apical: "rámulos con hoyuelo apical",
    ramulos_constriccion_basal: "rámulos con constricción basal",
    extremos_en_gancho: "extremos en forma de gancho",
    talo_intrincado_cojin: "talo intrincado en cojín",
    espinas_largas_bifurcadas: "espinas largas bifurcadas",
    talo_elastico_cartilaginoso: "talo elástico y cartilaginoso",
    talo_diminuto_intermareal_alto: "talo diminuto del intermareal alto",
    talo_plano_comprimido: "talo plano comprimido",
    ramificacion_pinnada_gracilaria: "ramificación pinnada tipo Gracilaria",
    talo_coriaceo_dicotomo: "talo coriáceo dicótomo",
    talo_plano_laminar: "talo plano laminar",
    lamina_flesh_gelatinosa: "lámina carnosa o gelatinosa",
    lamina_dividida_pinnada: "lámina dividida pinnadamente",
    apices_curvados_helicoide: "ápices curvados helicoidalmente",
    aspecto_corimboso_nudos_pubescentes: "aspecto corimboso con nudos pubescentes",
    cespedes_tiesos_negruzcos: "céspedes tiesos negruzcos",
    consistencia_gelatinosa_ramificacion_piramidal: "consistencia gelatinosa con ramificación piramidal",
    estrechamiento_base_rama: "estrechamiento en la base de la rama",
    filamentos_finos_ramificacion_alterna: "filamentos finos con ramificación alterna",
    filamentos_soporte_medulares: "filamentos de soporte medulares",
    pericentrales_4_a_6: "células pericentrales de 4 a 6",
    ramas_apicales_espiraladas_plumosas: "ramas apicales espiraladas y plumosas",
    ramas_erectas_muy_densas: "ramas erectas muy densas",
    ramas_espinas_apices_curvados: "ramas con espinas y ápices curvados",
    ramificacion_dorsiventral_pinnada: "ramificación dorsiventral pinnada",
    ramillas_unilaterales_peine: "ramillas unilaterales en forma de peine",
    talo_carnoso_cartilaginoso: "talo carnoso o cartilaginoso",
    talo_carnoso_quebradizo: "talo carnoso y quebradizo",
  };

  const cleanName = name.trim().toLowerCase();
  let displayName = customMap[cleanName] || name.replace(/_/g, " ");
  if (displayName && capitalize) {
                ...
                <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm">
                  ...
                  >
                    <span className="text-xs text-muted-foreground uppercase font-bold tracking-wider flex items-center gap-1.5">
                      ...
                      ¿Por qué se realiza esta pregunta?
                    </span>
                  ...
                  {showWhyPanel && (
                    <div className="p-5 space-y-4 text-xs leading-relaxed animate-fade-in-up font-sans">
                      <p className="text-muted-foreground">
                        Esta pregunta evalúa el carácter anatómico ficológico <span className="bg-secondary px-1.5 py-0.5 rounded text-foreground text-[11px] font-medium">{formatCharacterName(state.character_name)}</span> para descartar ramas lógicas incompatibles y reducir la incertidumbre diagnóstica.
                      </p>
                ...
                {state.user_choices.map((choice, index) => (
                  <div key={index} className="bg-secondary/25 border border-border/40 rounded p-2.5 text-xs flex flex-col gap-1.5">
                    <div className="flex justify-between items-start gap-2">
                      <span className="font-semibold text-primary text-[10px]">C{index + 1}: {formatCharacterName(choice.character_name, true)}</span>
